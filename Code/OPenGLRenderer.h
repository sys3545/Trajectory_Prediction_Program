...
typedef struct vecInfo_t {
	...
	GLfloat n = 0.0f, M = 0.0f, E = 0.0f, F = 0.0f, preRadius = 0.0f, preF = 0.0f, preTime = 0.0f; // n : mean motion, M : mean anomaly, E : eccentric anomaly, F : hyperbolic anomaly
	GLfloat y = 0.0f; // near parabolic orbit 계산 시 쓰이는 변수
